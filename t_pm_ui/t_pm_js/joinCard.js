...
function openjoinCardModal(ticketTitle, ticketId) {
  ...
  const joinCardContent = ` <div class="mb-4">
                  ...
                  <div class="mb-4"><button type="button" class="btn btn-primary btn-sm me-4" onclick="joinCard('${ticketId}')">Join
  ...
  fetch(`${API_BASE_URL}${API_ROUTES.GET_JOIN_CARDS}`)
    ...
    .then(data => {
      data.map(item => {
        ...
        // if (item.joined_username === joined_username) {
        //   console.log("card allready joined");

        //   leaveCard(item.ticket_id);
        // }
                ...
                <ul class="p-0 m-0 mx-4 mx-md-0" id="list-content">
                  ...
                  <li class="d-flex flex-wrap mb-4">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-2">
                        <p class="mb-0 text-heading">Thunder <span class="badge bg-label-success me-1">Admin</span>
                        </p>
                  ...
                  <li class="d-flex flex-wrap mb-4">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-2">
                        <p class="mb-0 text-heading">Aman <span class="badge bg-label-info me-1">Team Member</span>
                        </p>
                  ...
                  <li class="d-flex flex-wrap mb-4">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-2">
                        <p class="mb-0 text-heading">Gautam <span class="badge bg-label-info me-1">Team Member</span>
                        </p>
                  ...
                  <li class="d-flex flex-wrap mb-4">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-2">
                        <p class="mb-0 text-heading">Utkarsh <span class="badge bg-label-info me-1">Team Member</span>
                        </p>
