...
if (!API_BASE_URL) {
  ...
  fetch(`${API_BASE_URL}${API_ROUTES.AUTOMATION_DATA}`)
    ...
    .then(data => {
      ...
      data.forEach(item => {
        const ruleContent = `
          <div class="main-content border py-6" style="margin-top: 50px;">      
              ...
              <div class="row d-flex justify-content-between">
                <div class="col-8">
                  <ul class="d-flex">
                    ...
                    <li class="menu-item">
                      <a href="javascript:void(0)" class="menu-link me-1">
                    ...
                    <li class="menu-item">
                      <a href="javascript:void(0)" class="menu-link me-1" onclick="deleteAutomationButton(${item.id})">
                ...
                <div class="col-4">
                  <span><a href="javascript:void(0)" style="color:#333232;">Enabled on 1 board,</a> last modified a month ago</span>
                </div>
              </div>
        ...
        automationRule.insertAdjacentHTML("beforeend", ruleContent);
      });
    })
    .catch(error => {
...
async function deleteAutomationButton(id) {
  try {
    ...
    if (response.ok) {
      console.log("Successfully deleted automation button");
      window.location.reload();
    } else {
      console.error("Error deleting automation button");
      window.location.reload();
    }
  } catch (error) {
