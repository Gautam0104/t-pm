document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadOrder() {
        const savedOrder = localStorage.getItem("kanbanOrder");
        if (savedOrder) {
