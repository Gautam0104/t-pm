...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadBoards() {
        fetch(`${API_BASE_URL}${API_ROUTES.PROJECT_DATA}`)
            ...
            .catch(error => {
                ...
                boardSelect.innerHTML = "<option disabled>Error loading boards</option>";
            });
    }
    ...
    mirrorBtn.addEventListener("click", () => {
        ...
        const selectedList = listSelect.options[listSelect.selectedIndex].textContent;
        ...
        fetch(`${API_BASE_URL}/ticket/mirroring/504`, {
            method: "POST",
