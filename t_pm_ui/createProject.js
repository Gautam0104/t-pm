// Create Project 
document.getElementById('createProjectorTicket').addEventListener('submit', async function (e) {
    ...
    if (project_name === '') {
        document.getElementById('nameError').textContent = 'Project/Ticket Name is required.';
        isValid = false;
    }
    // if (status === '') {
    ...
    if (isValid) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/project`, {
                ...
                body: JSON.stringify({ project_name, project_leader_id, description, status, project_type, total_eta }),
            });
